...
public class PropertiesHelper {
    ...
    private static String relPropertiesFilePathDefault = "src/main/resources/login.properties";

    public static Properties loadAllFiles() {
        LinkedList<String> files = new LinkedList<>();
        // Add tất cả file Properties vào đây theo mẫu
        files.add("src/main/resources/login.properties");
        files.add("src/main/resources/excelPath.properties");
